    ...
    >
      <v-card :loading="loader" active-class="22" color="deep-purple lighten-5">
        <v-card-title class="title">
          <v-row>
            <v-col cols="2"></v-col>
            <v-col cols="8"><span class="headline">New Room Add vue components</span>
            </v-col>
            <v-col cols="2">
...
<!--              begin exam text-->
              <v-col cols="12">
                <v-row>
                <v-col cols="4"></v-col>
                <v-col cols="4"><span style="color: #7C4DFF">Begin exam</span></v-col>
                <v-col cols="4"></v-col>
              </v-row>
              </v-col>
              <v-row>
              ...
              <v-row>
                ...
                <v-col cols="4">
                  <v-text-field
                      label="duringTime"  outlined  dense
